                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Text(ayats[index].ayat,style: TextStyle(fontSize: 20,color: Colors.black)),
                    ),
                  ),
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text("Bangla \n" + ayats[index].banglaTranslation,style: TextStyle(fontSize: 18),),
                  ),
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text("English \n" + ayats[index].englishTranslation,style: TextStyle(fontSize: 18),)
                  )
                ],
              ),
            );
